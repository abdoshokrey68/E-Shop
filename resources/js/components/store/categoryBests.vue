<template>
    <div class="container p-0" style="margin-top:55px">
        <div class="best-items">
            <h5 style="font-size:24px" class=" text-style"> {{lang.best_items}} </h5>
            <hr class="mt-1">
            <div class="row">
                <div class="col-md-12" v-for="item in bestitems" :key="item.index">
                    <div class="row">
                        <div class="col-3 p-0">
        ...
        <div class="otjer-items">
            <h5 style="font-size:24px" class=" text-style"> {{lang.other_items}} </h5>
            <hr class="mt-1">
            <div class="row">
                <div class="col-md-12" v-for="item in otheritems" :key="item.index">
                    <div class="row">
                        <div class="col-3 p-0">
                            <div class="swiper-slide" v-if="item.image">
                                <img :src="'/image/items/'+item.image" class="image-res" :alt="item.name">
