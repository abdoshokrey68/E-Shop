...
{{-- <div class="error">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="clear"></div>
                <form role="form" action="{{route('dashboard.career.update', $career->id)}}" class="col-md-12" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 p-0">
                            <input
                                    ...
                                    type="text"
                                    value="@if($errors->any()){{old('name')}}@else{{$career->name}} @endif "
                                    required/>
                            @error('name')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 p-0">
                            <input
                                    ...
                                    type="number"
                                    value="@if($errors->any()){{old('salary')}}@else{{$career->salary}} @endif "
                                    required/>
                                    <div class="col-md-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 p-0">
                            <textarea
                                ...
                                required>@if($errors->any()){{old('des')}}@else{{$career->des}}@endif</textarea>
                            @error('des')
                                <div style='color:#a94442'>
                                    <small>
                                        <i class="fas fa-exclamation-triangle"></i>
                    ...
                    <div class="form-group row mt-5">
                        ...
                        <div class="col-lg-9">
                            <a href="{{route('dashboard.career.create', $career->id)}}" class="btn btn-secondary col-md-4 mr-2 ml-2" value="Cancel"> @lang('site.cancel') </a>
